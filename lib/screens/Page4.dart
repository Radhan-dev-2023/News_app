            ...
            children: [
              ...
              return  Expanded(
                  child: newsProvider.isLoading
                    ...
                    itemCount: newsProvider.albumBusiness?.articles.length ?? 0,
                    itemBuilder: (context, index) {
                      final article = newsProvider.albumBusiness?.articles[index];
