              ...
              Consumer(builder: (BuildContext context, NewsProvider newsProvider, _){
                return Expanded(
                  child: newsProvider.isLoading
                    ...
                    itemCount: newsProvider.albumWallStJrnl?.articles.length ?? 0,
                    itemBuilder: (context, index) {
                      final article = newsProvider.albumWallStJrnl?.articles[index];
                      return Container(
